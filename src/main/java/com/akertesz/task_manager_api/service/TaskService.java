...
public interface TaskService {
    ...
    Optional<TaskDto> updateTask(UUID id, UpdateTaskRequest request);
    ...
    // Change task status
    Optional<TaskDto> changeTaskStatus(UUID id, TaskStatus status);
    
    // Change task priority
    Optional<TaskDto> changeTaskPriority(UUID id, TaskPriority priority);
